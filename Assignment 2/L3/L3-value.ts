...
export const makeObject = (c: Class): Object => ({tag: "Object", val: c});
export const isObject = (x: any): x is Object => x.tag === "Object";

export const makeClass = (c: ClassExp): Class => ({tag: "Class", val: c, env: makeEmptyEnv()});
export const makeClassEnv = (c: ClassExp, e: Env): Class => 
    ({tag: "Class", val: c, env: e});
